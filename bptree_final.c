...
int main() {
    ...
    // b_plus_tree_delete(root, &root, 10);
    // b_plus_tree_delete(root, &root, 20);
    // b_plus_tree_delete(root, &root, 30);
    // b_plus_tree_delete(root, &root, 40);
    ...
    // b_plus_tree_delete(root, &root, 100);
    // b_plus_tree_delete(root, &root, 110);
